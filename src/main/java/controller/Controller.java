...
public class Controller extends HttpServlet {
	...
	protected void contatos(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// criando um objeto que ira receber dados JavaBeans
	...
	protected void listarContato(HttpServletRequest request, HttpServletResponse response)
		...
		// setar os atributos do fomulario com as variaveis do JavaBeans
	...
	protected void deletarContato(HttpServletRequest request, HttpServletResponse response)
		...
		String idcon = request.getParameter("idcon");
		//setar a variavel idcon na variavel idcon do javabeans
		contato.setIdcon(idcon);
		//executar o metodo deletarContato (DAO) passando o objeto como parametro
		dao.deletarContato(contato);
		//redirecionar a pagina agenda.jsp atualizando a pagina
		response.sendRedirect("main");
	}
}
